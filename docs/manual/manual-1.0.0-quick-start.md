...
This is an indicator for the default city you chose in the **Weather** application. *Click* on this and the **Weather** app wil rise. Weather app has two panels, the **menu** (1) and the **viewer** (2).
